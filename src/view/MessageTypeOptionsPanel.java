 ...
 * @author jim
 */
public class MessageTypeOptionsPanel extends javax.swing.JPanel {

    private Database db = null;
    private MessageType type;
    private JList messageTypeList = null;
    /**
     * Creates new form LanguageOptionsPanel
     */
    public MessageTypeOptionsPanel(Database db, MessageType type, JList messageTypeList) {
        initComponents();
        fillComboBox(db);
        this.db = db;
        this.type = type;
    ...
    public void updateDescription(){
        if(messageTypeList != null){
            try{
                ...
                descriptionTextField.setText(db.getMessageTypeDescription(type.id, language));
            }
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        db.updateMessageTypeDescription(type.id, (Language)languageComboBox.getSelectedItem(), descriptionTextField.getText());
        updateDescription();
        messageTypeList.setListData(db.toMessageTypeArray());
    }//GEN-LAST:event_updateButtonActionPerformed

    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        db.deleteMessageTypeDescription(type.id, ((Language)languageComboBox.getSelectedItem()).id);
        updateDescription();
        messageTypeList.setListData(db.toMessageTypeArray());
    ...
    {//GEN-HEADEREND:event_addButtonActionPerformed
        ...
        db.addMessageTypeDescription(language, type.id, description);
        updateDescription();
    }//GEN-LAST:event_addButtonActionPerformed

    private void deleteAllButtonActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_deleteAllButtonActionPerformed
    {//GEN-HEADEREND:event_deleteAllButtonActionPerformed
        db.deleteAllMessageTypeDescriptions(type.id);
        updateDescription();
        messageTypeList.setListData(db.toMessageTypeArray());
